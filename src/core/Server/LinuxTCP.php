...
class LinuxTCP
{
    ...
    public function alarm_handler()
    {
        $this->run_check();
        $this->init_alarm();
    }

    public function init_alarm()
    {
    ...
    public function keeplive($client_id)
    {
     ...
     * @param $gid
     */
    public function setuid($uid, $gid)
    {
        posix_setuid($uid);
        posix_setgid($gid);
    }
